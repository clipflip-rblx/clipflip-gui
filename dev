...
local clipflipver = "2.0.30"
local buildtype = "Canary"
local lplayer = game.Players.LocalPlayer
local gameName = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
local supported = {"solara", "codex", "arceus x", "delta", "hydrogen", "vega x", "frost", "frostware", "ethos", "alysse", "alysse android", "trigon evo", "trigon", "moreunc", "fluxus"}
local unsupported = {"incognito", "evon", "lunar"}
local solara = {"solara"}
local Noclip = nil
local Clip = nil
...
local Window = Fluent:CreateWindow({ Title = "Clipflip GUI " .. clipflipver, SubTitle = buildtype, TabWidth = 160, Size = UDim2.fromOffset(580, 460), Acrylic = false, Theme = "Dark", MinimizeKey = D})
...
local Tabs = {
    ...
    Game = Window:AddTab({ Title = "Game Specific", Icon = "gamepad" }),
    ...
    QuickCmds = Window:AddTab({ Title = "Quick Commands", Icon = "terminal"}),
...
Tabs.Home:AddParagraph({
 ...
 Tabs.Home:AddParagraph({
     Title = "You are using "..identifyexecutor().. ".",
    ...
    Tabs.Univ:AddButton({
        ...
        Tabs.Aim:AddButton({
        Title = "Owl Hub",
        Description = "Universal Script Hub with aimbot and ESP",
        Callback = function()
            Window:Dialog({
                Title = "Information",
...
Tabs.QuickCmds:AddButton({
        Title = "Noclip",
        Description = "Walk thru walls",
        Callback = function()
            Window:Dialog({
                Title = "Information",
                Content = "This will give you the ability to noclip.",
                Buttons = {
                    {
                        Title = "Okay",
                        Callback = function()
    ...
    Tabs.UsefulTools:AddButton({
        ...
        Tabs.Game:AddButton({
        Title = "Zap Hub",
        Description = "Multiple popular games",
        Callback = function()
            Window:Dialog({
                Title = "Information",
    ...
    Tabs.Game:AddButton({
        Title = "CMD v3",
        Description = "Game: Kohls Admin House NBC",
        Callback = function()
            Window:Dialog({
                Title = "Information",
    ...
    Tabs.Aim:AddButton({
        Title = "Reaper Hub",
        Description = "Multiple popular games, has aimbot and ESP",
        Callback = function()
            Window:Dialog({
                Title = "Information",
...
SaveManager:SetFolder("ClipfipScripts/ClipflipGUI")
...
Fluent:Notify({ Title = "Clipflip GUI", Content = "The script has loaded successfully.",Duration = 8 })
